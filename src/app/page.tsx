        ...
        <PageAnimator animateElements={true}>
            ...
            >
                ...
                <motion.div variants={itemVariants} className="flex-1">
                    <Link
                        href="/contact"
                        className="flex justify-center items-center outline-none px-6 py-2 mt-4 border border-txt-light dark:border-txt-dark rounded hover:bg-bck-dark dark:hover:bg-bck-light hover:text-txt-dark dark:hover:text-txt-light cursor-pointer transition-all duration-300"
                    >
                        <p>Let&apos;s Connect</p>
                    </Link>
                </motion.div>
