...
export default function AppLayout({
    ...
    return (
        <div className="min-h-dvh flex flex-col justify-between font-[family-name:var(--font-jetbrains-mono)] text-txt-light dark:text-txt-dark">
            ...
            <Header />
            <main>
                <section className="grid grid-rows-1 items-center justify-items-center h-full p-8 gap-16 sm:px-20 lg:px-40 font-[family-name:var(--font-jetbrains-mono)] dark:text-white overflow-visible">
